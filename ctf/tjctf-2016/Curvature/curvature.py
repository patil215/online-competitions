...
def generate(x, y, prime):
  return str(multiply((Gx, Gy), prime))
...
primelist = rwh_primes1(1000000)
print "got list"

print "done"
#print len(primelist)
for i in range(9499, len(primelist)):
    if i % 100 == 0:
        print i
    prime = primelist[i]
    if str(multiply((Gx,Gy), prime)) == "(10150325274093651859575658519947563789222194633356867789068177057343771571940302488270622886585658965620106459791565259790154958179860547267338437952379763L, 6795014289013853849339410895464797184780777251924203530417684718894057583288011725702609805686960505075072642102076744937056900144377846048950215257629102L)":
        print prime
        break
print "done"
